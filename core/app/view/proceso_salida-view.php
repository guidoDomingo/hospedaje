                        ...
                        <ul class="list-group list-group-unbordered">
                            <li class="list-group-item" style="border-top: 2px solid black;">
                                <b>Nombre habitación</b> <a
                                    class="pull-right"><?php echo $habitacion->getHabitacion()->nombre; ?></a>
                            </li>
                            <li class="list-group-item">
                                <b>Tipo </b> <a
                                    class="pull-right"><?php echo $habitacion->getHabitacion()->getCategoria()->nombre.' / Tarifa: '. $habitacion->getTarifaHabitacion()->getTarifa()->nombre; ?></a>
                            </li>
                ...
                <div class="col-md-5">
                    ...
                    <div class="box-body box-profile">
                        ...
                        <ul class="list-group list-group-unbordered">
                            ...
                            <li class="list-group-item">
                                <b>Documento</b> <a
                                    class="pull-right"><?php echo $habitacion->getCliente()->documento; ?></a>
                            </li>

                            <!-- Modal -->
                            <div class="modal fade bs-example-modal-lg" id="mostrar_cliente" tabindex="-1" role="dialog"
                            ...
                            foreach($tmps as $p):  ?>
                                                    <tr>
                                                        ...
                                                        <td><b><?php echo $p->getCliente()->getTipoDocumento()->nombre; ?></b>
                                                        </td>
                                                        <td><?php echo $p->getCliente()->documento; ?></td>
                                                        <td><?php echo $p->getCliente()->nombre; ?></td>

                                                        <td><?php if($p->getCliente()->giro!=NULL and $p->getCliente()->giro!='0000-00-00'){ echo $p->getCliente()->giro;}else{ echo "--------";} ?>
                                                        </td>
                                                        <td><?php if($p->getCliente()->direccion!="NULL"){ echo $p->getCliente()->direccion; }else{ echo "--------";} ?>
                                                        </td>
                                                        <td><?php if($p->getCliente()->nacionalidad!="NULL"){ echo $p->getCliente()->nacionalidad; }else{ echo "--------";} ?>
                                                        </td>
                                                        <td><?php if($p->getCliente()->estado_civil!="NULL"){ echo $p->getCliente()->estado_civil; }else{ echo "--------";} ?>
                                                        </td>
                                                        <td><?php if($p->getCliente()->ocupacion!="NULL"){ echo $p->getCliente()->ocupacion; }else{ echo "--------";} ?>
                                                        </td>
                                                        <td><?php if($p->getCliente()->medio_transporte!="NULL"){ echo $p->getCliente()->medio_transporte; }else{ echo "--------";} ?>
                                                        </td>
                                                        <td><?php if($p->getCliente()->destino!="NULL"){ echo $p->getCliente()->destino; }else{ echo "--------";} ?>
                                                        </td>
                                                        <td><?php if($p->getCliente()->motivo!="NULL"){ echo $p->getCliente()->motivo; }else{ echo "--------";} ?>
                                                        </td>
  ...
  ?>
            ...
            <div class="col-md-12">
                        ...
                        <table class="table table-bordered">
                            ...
                            <form action="index.php?view=addsalida" method="post" name="sumar">
                                <tr>
                                    ...
                                    <input type="hidden" name="numero" size="2"
                                        value="<?php echo $habitacion->precio; ?>" onKeyUp="fncSumar()">

                                    <input type="hidden" name="numero1" size="2"
                                        value="<?php echo $habitacion->cant_noche; ?>" onKeyUp="fncSumar()">

                                    <td style="border-right: 1px solid #a09e9e;" colspan="2"><input type="number"
                                            value="0" id="numero2" name="numero2" size="2" onKeyUp="fncSumar()"
                                            onchange="fncSumar()" min="0"></td>

                                    <td><input type="text"
                                            value="<?php echo $habitacion->precio*$habitacion->cant_noche; ?>"
                                            style="border-color: red;" readonly="readonly" name="resultado" /></td>
                                ...
                                <tr>
                                    ...
                                    <th style="width: 40px"> <?php if($habitacion->pagado=='0'){ ?><h4
                                            style="color: red;">FALTA PAGAR</h4><?php }else{ ?><h4 style="color: blue;">
                                            PAGADO</h4><?php }; ?></th>
                                </tr>
                      ...
                      if(count($productos)>0){ ?>
                                ...
                                <tr>
                                    ...
                                    <td><span class="badge"><b>$
                                                <?php echo number_format($sub_total,2,'.',','); ?></b></span></td>
                                </tr>
                ...
                ?>
                                ...
                                <input type="hidden" name="id_tipo_pago"
                                    value="<?php echo $habitacion->id_tipo_pago; ?>">
                                <input type="hidden" name="nro_operacion"
                                    value="<?php echo $habitacion->nro_operacion; ?>">
                    ...
                    <div class="box-footer clearfix">
                        ...
                        <button type="submit" name="boleta" class="btn btn-success pull-right"><i
                                class='fa fa-print'></i> Imprimir Boleta</button>
