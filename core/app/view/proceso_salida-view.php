                    ...
                    <div class="col-md-12">
                        <div class="box box-default">
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <form action="index.php?view=addsalida" method="post" name="sumar">
                                        ...
                                        <tr>
                                            ...
                                            <th style="width: 40px"> <?php if ($habitacion->pagado == '0') { ?><h4 style="color: red;">FALTA PAGAR</h4><?php } else { ?><h4 style="color: blue;">
                                                        PAGADO</h4><?php }; ?></th>
                                        </tr>
                            ...
                            <form id="habilitarhabitacion-form" action="index.php?view=habilitarhabitacion" method="post">
                                <input type="hidden" name="id_habitacion" value="<?php echo $habitacion->getHabitacion()->id; ?>">
                                <input type="hidden" name="id_operacion" value="<?php echo $habitacion->id; ?>">
                                <button type="submit" class="btn btn-danger" form="habilitarhabitacion-form"><i class='fa fa-sign-out'></i> Cancelar</button>
                            </form>
