                                        ...
                                        <section class="tile time-simple">
                                            ...
                                            <div class="tile-body">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <!-- col -->
                                                    <div class="col-md-9">
                                                        <p class="text-default lt">Creado:
                                                            <?php echo $operacion->fecha_salida; ?></p>
                                                ...
                                                <div class="row b-t pt-20">
                                                    ...
                                                    <div class="col-md-5">
                                                        ...
                                                        <ul class="list-unstyled text-default lt mb-20">
                                                            <li><strong class="inline-block w-xs">Nombre:</strong>
                                                                <?php echo $operacion->getCliente()->nombre; ?></li>
                                                            <li><strong class="inline-block w-xs">Documento:</strong>
                                                                <?php echo $operacion->getCliente()->documento; ?></li>
                                                            <li><strong class="inline-block w-xs">Dirección:</strong>
                                                                <?php echo $operacion->getCliente()->direccion; ?></li>
                                            ...
                                            <div class="tile-body p-0">
                                                ...
                                                <div class="table-responsive">
                                                    <table class="table table-hover table-striped">
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td><a href="javascript:;"><?php echo $operacion->cant_noche; ?></a>
                                                                </td>
                                                                <td><?php echo 'Alojamiento de la habitación ' . $operacion->getHabitacion()->nombre; ?>
                                                                </td>
                                                                <td>$
                                                                    <?php echo number_format($operacion->precio, 2, '.', ','); ?>
                                                                </td>
                                                                <td class="ng-binding"><b>$
                                                                        <?php echo number_format(($operacion->precio * $operacion->cant_noche) + $operacion->total, 2, '.', ','); ?>
                                                                    </b></td>
                                                            ...
                                                            if (count($productos) > 0) { ?>
                                                                ...
                                                                <?php foreach ($productos as $producto) : ?>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td><b>$
                                                                                <?php echo number_format($sub_total, 2, '.', ','); ?></b>
                                                                        </td>
                                        ...
                                        <section class="tile tile-simple bg-tr-black lter">
                                            ...
                                            <div class="tile-body">
                                                ...
                                                <ul class="list-unstyled">
                                                    ...
                                                    <li class="ng-binding"><strong class="inline-block w-sm mb-5">Iva:</strong> $
                                                        <?php echo number_format(($final / 11), 2, '.', ','); ?> </li>
                                                    <li class="ng-binding"><strong class="inline-block w-sm mb-5">SubTotal:</strong> $
                                                        <?php echo number_format($final - ($final / 11), 2, '.', ','); ?></li>
                                                    <li class="ng-binding"><strong class="inline-block w-sm mb-5">
                                                            Total:</strong> $ <?php echo number_format($final, 2, '.', ','); ?>
                                                    </li>
