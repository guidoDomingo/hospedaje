                                                            ...
                                                            <div class="form-group">
                                                                <div class="input-group">
                                                                    <span class="input-group-addon"> Puntos alcanzar
                                                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </span>
                                                                    <input type="text" class="form-control" disabled=""
                                                                        name="" value="<?php echo $cliente->limite; ?>">
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="form-group">
                                                                <div class="input-group">
                                                                    ...
                                                                    <select name="tipo_documento" required
                                                                        ...
                                                                        <option
                                                                            value="<?php echo $tipo_documento->id; ?>" <?php if ($cliente->tipo_documento != null && $cliente->tipo_documento == $tipo_documento->id) {
                                                                                                echo "selected";
                                                                                              } ?>>
                                ...
                                <div class="col-md-offset-1 col-md-10">
                                    ...
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control col-md-8" name="documento" required
                                                placeholder="Ingrese documento">
                                        </div>
                                    </div>
