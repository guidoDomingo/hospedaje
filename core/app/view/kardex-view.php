                 ...
                 class="form-control input-sm" style=""> -->
                  ...
                  ?>
                                    <select class="form-control" name="anio">
                                        <option value="2017" <?php if($anio=='2017'){ echo "selected";}; ?>>2017
                                        </option>
                                        <option value="2018" <?php if($anio=='2018'){ echo "selected";}; ?>>2018
                                        </option>
                                        <option value="2019" <?php if($anio=='2019'){ echo "selected";}; ?>>2019
                                        </option>
                                        <option value="2020" <?php if($anio=='2020'){ echo "selected";}; ?>>2020
                                        </option>
                                        <option value="2021" <?php if($anio=='2021'){ echo "selected";}; ?>>2021
                                        </option>
                                        <option value="2022" <?php if($anio=='2022'){ echo "selected";}; ?>>2022
                                        </option>
                                        <option value="2023" <?php if($anio=='2022'){ echo "selected";}; ?>>2023
                                        </option>
                                    </select>
                                </div>
                            </div>
                ...
                <input type="text" id="txtMes" name="txtMes" placeholder=""
                 class="form-control input-sm" style=""> -->
                                    <select class="form-control" name="mes">
                                        <option value="00" <?php if($me=='00'){ echo "selected";}; ?>>--- Todos ---
                                        </option>
                            ...
                            <div class="col-sm-4">
                                <button style="margin-top: 27px;" id="btnGuardar" type="submit"
                        ...
                        <ul class="controls">
                            ...
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu pull-right with-arrow animated littleFadeInUp">
                                    <li><a id="print_saldos"
                                            href="reporte/pdf/documentos/reporte_kardex_todo.php?anio=<?php echo $anio; ?>&mes=<?php echo $me; ?>"
                                            target="_blanck"><i class="icon-file-pdf"></i> Saldos y Movimientos</a></li>
                                    <li class="divider"></li>
                                    <li><a id="print_entradas"
                                            href="reporte/pdf/documentos/reporte_kardex_entrada.php?anio=<?php echo $anio; ?>&mes=<?php echo $me; ?>"
                                            target="_blanck">
                                            <i class="icon-file-pdf"></i> Entradas del Mes</a></li>
                                    <li class="divider"></li>
                                    <li><a id="print_salidas"
                                            href="reporte/pdf/documentos/reporte_kardex_salida.php?anio=<?php echo $anio; ?>&mes=<?php echo $me; ?>"
                                            target="_blanck">
                ...
                if(count($productos)>0){
                  ...
                  ?>
                        ...
                        ?>
                                ...
                                <td><?php if($producto->marca!="NULL"){ echo $producto->marca;}else{ echo "------"; } ?>
                                </td>
